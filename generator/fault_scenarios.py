...
SCENARIO_02_DISK_FULL_CHECKOUT = FaultScenario(
    ...
    alert_templates=[
        ...
        },
        {
            ...
            "device": "checkout",
            "metric": "http_latency_seconds",
            "message_template": "checkout disk wait latency {value:.1f}s",
            "value_range": [2.0, 7.0],
        },
        {
            "domain": "service_mesh",
            ...
            "device": "frontend",
            "metric": "http_error_rate_per_min",
            "message_template": "frontend checkout dependency errors {value:.0f}/min",
            "value_range": [10.0, 25.0],
        },
        {
            "domain": "application",
            ...
            "device": "frontend-proxy",
            "metric": "http_error_rate_per_min",
            "message_template": "frontend-proxy upstream 5xx at {value:.0f}/min",
        ...
        },
        {
            ...
            "device": "cart",
            "metric": "http_latency_seconds",
            "message_template": "cart latency due to checkout retries {value:.1f}s",
            "value_range": [1.0, 3.0],
        },
        {
            "domain": "application",
            ...
            "message_template": "checkout connection pool saturation {value:.2f}",
            "value_range": [0.75, 0.95],
        },
        {
            "domain": "application",
            "severity": "warning",
            "device": "frontend",
            "metric": "http_error_rate_per_min",
            "message_template": "end-user checkout flow failures {value:.0f}/min",
            "value_range": [4.0, 10.0],
        },
    ],
)
    ...
    alert_templates=[
        {
            ...
            "message_template": "product-catalog disk I/O latency {value:.1f}ms",
            "value_range": [60.0, 150.0],
        },
        {
            "domain": "application",
            "severity": "major",
        ...
        },
        {
            ...
            "metric": "http_latency_seconds",
            "message_template": "recommendation dependency latency {value:.1f}s",
            "value_range": [1.5, 4.5],
        },
        {
            "domain": "application",
        ...
        },
        {
            ...
            "device": "cart",
            "metric": "http_latency_seconds",
            "message_template": "cart product lookup latency {value:.1f}s",
            "value_range": [1.0, 3.0],
        },
        {
            "domain": "application",
            ...
            "device": "frontend",
            "metric": "http_error_rate_per_min",
            "message_template": "end-user browse errors {value:.0f}/min",
            "value_range": [2.0, 8.0],
        },
    ],
)
...
SCENARIO_04_OOM_PAYMENT = FaultScenario(
    ...
    alert_templates=[
        ...
        },
        {
            ...
            "device": "payment",
            "metric": "http_latency_seconds",
            "message_template": "payment latency after restart {value:.1f}s",
            "value_range": [2.0, 6.0],
        },
        {
            "domain": "service_mesh",
        ...
        },
        {
            ...
            "device": "checkout",
            "metric": "http_latency_seconds",
            "message_template": "checkout transaction latency {value:.1f}s",
            "value_range": [1.5, 4.0],
        },
        {
            "domain": "application",
            ...
            "device": "frontend-proxy",
            "metric": "http_error_rate_per_min",
            "message_template": "frontend-proxy payment path 5xx {value:.0f}/min",
        ...
        },
        {
            ...
            "device": "frontend",
            "metric": "http_error_rate_per_min",
            "message_template": "end-user payment failures {value:.0f}/min",
            "value_range": [2.0, 7.0],
        },
    ],
)
    ...
    alert_templates=[
        {
            ...
            "message_template": "recommendation CPU saturation at {value:.1f}%",
            "value_range": [97.0, 100.0],
        },
        {
            "domain": "infrastructure",
            "severity": "major",
        ...
        },
        {
            ...
            "device": "frontend-proxy",
            "metric": "http_latency_seconds",
            "message_template": "frontend-proxy recommendation latency {value:.1f}s",
            "value_range": [1.2, 3.5],
        },
        {
            "domain": "application",
            ...
            "device": "recommendation",
            "metric": "http_error_rate_per_min",
            "message_template": "recommendation timeout errors {value:.0f}/min",
            "value_range": [10.0, 25.0],
        },
        {
            "domain": "application",
        ...
        },
        {
            ...
            "device": "product-catalog",
            "metric": "http_latency_seconds",
            "message_template": "product-catalog recommendation lookups {value:.1f}s",
            "value_range": [1.0, 2.8],
        },
        {
            "domain": "application",
            ...
            "device": "frontend",
            "metric": "http_error_rate_per_min",
            "message_template": "end-user recommendations degraded {value:.0f}/min",
            "value_range": [2.0, 8.0],
        },
    ],
)
    ...
    alert_templates=[
        {
            ...
            "message_template": "shipping severe throttle ratio {value:.2f}",
            "value_range": [0.9, 1.0],
        },
        {
            "domain": "infrastructure",
        ...
        },
        {
            ...
            "device": "frontend",
            "metric": "http_latency_seconds",
            "message_template": "frontend shipping ETA latency {value:.1f}s",
            "value_range": [1.5, 4.5],
        },
        {
            "domain": "application",
        ...
        },
        {
            ...
            "device": "cart",
            "metric": "http_latency_seconds",
            "message_template": "cart shipping quote latency {value:.1f}s",
            "value_range": [1.0, 3.0],
        },
        {
            "domain": "application",
            ...
            "device": "frontend",
            "metric": "http_error_rate_per_min",
            "message_template": "end-user shipping errors {value:.0f}/min",
            "value_range": [2.0, 8.0],
        },
    ],
)
...
SCENARIO_07_NETWORK_PARTITION_KAFKA = FaultScenario(
    ...
    alert_templates=[
        ...
        },
        {
            ...
            "severity": "major",
            "device": "kafka",
            "metric": "network_packet_loss_percent",
            "message_template": "kafka packet loss at {value:.1f}%",
        ...
        },
        {
            ...
            "metric": "consumer_lag",
            "message_template": "fraud-detection consumer lag {value:.0f}",
        ...
        },
        {
            ...
            "device": "checkout",
            "metric": "http_latency_seconds",
            "message_template": "checkout event processing latency {value:.1f}s",
            "value_range": [1.5, 4.5],
        },
        {
            "domain": "application",
            ...
            "device": "frontend",
            "metric": "http_error_rate_per_min",
            "message_template": "end-user order status errors {value:.0f}/min",
            "value_range": [2.0, 8.0],
        },
    ],
)
    ...
    alert_templates=[
        {
            ...
            "message_template": "currency DNS hard failures {value:.0f}/min",
            "value_range": [25.0, 60.0],
        },
        {
            "domain": "application",
            "severity": "major",
        ...
        },
        {
            ...
            "device": "cart",
            "metric": "http_latency_seconds",
            "message_template": "cart pricing latency {value:.1f}s",
            "value_range": [1.0, 3.0],
        },
        {
            "domain": "application",
            ...
            "device": "frontend-proxy",
            "metric": "http_error_rate_per_min",
            "message_template": "frontend-proxy upstream currency errors {value:.0f}/min",
            "value_range": [3.0, 9.0],
        },
        {
            "domain": "application",
            ...
            "device": "frontend",
            "metric": "http_error_rate_per_min",
            "message_template": "end-user price display errors {value:.0f}/min",
            "value_range": [2.0, 7.0],
        },
    ],
)
...
SCENARIO_09_LB_FAILURE_FRONTEND_PROXY = FaultScenario(
    ...
    alert_templates=[
        ...
        },
        {
            ...
            "device": "frontend-proxy",
            "metric": "http_latency_seconds",
            "message_template": "frontend-proxy upstream latency {value:.1f}s",
            "value_range": [1.5, 5.0],
        },
        {
            "domain": "application",
        ...
        },
        {
            ...
            "device": "checkout",
            "metric": "http_error_rate_per_min",
            "message_template": "checkout edge routing failures {value:.0f}/min",
            "value_range": [8.0, 20.0],
        },
        {
            "domain": "application",
        ...
        },
        {
            ...
            "device": "cart",
            "metric": "http_error_rate_per_min",
            "message_template": "cart UI request errors {value:.0f}/min",
            "value_range": [3.0, 10.0],
        },
        {
            "domain": "application",
            ...
            "device": "frontend",
            "metric": "http_error_rate_per_min",
            "message_template": "end-user storefront failures {value:.0f}/min",
            "value_range": [3.0, 9.0],
        },
    ],
)
...
SCENARIO_10_CERT_EXPIRY_PAYMENT = FaultScenario(
    ...
    alert_templates=[
        ...
        },
        {
            ...
            "device": "payment",
            "metric": "http_error_rate_per_min",
            "message_template": "payment TLS rejection rate {value:.0f}/min",
            "value_range": [18.0, 45.0],
        },
        {
            "domain": "service_mesh",
            "severity": "major",
        ...
        },
        {
            ...
            "device": "checkout",
            "metric": "http_latency_seconds",
            "message_template": "checkout TLS retry latency {value:.1f}s",
            "value_range": [1.2, 3.8],
        },
        {
            "domain": "application",
            ...
            "device": "frontend-proxy",
            "metric": "http_error_rate_per_min",
            "message_template": "frontend-proxy payment upstream errors {value:.0f}/min",
            "value_range": [3.0, 9.0],
        },
        {
            "domain": "application",
            ...
            "device": "frontend",
            "metric": "http_error_rate_per_min",
            "message_template": "end-user payment auth failures {value:.0f}/min",
            "value_range": [2.0, 7.0],
        },
    ],
)
    ...
    alert_templates=[
        {
            ...
            "message_template": "checkout hard config failures {value:.0f}/min",
            "value_range": [20.0, 50.0],
        },
        {
            "domain": "application",
            "severity": "major",
        ...
        },
        {
            ...
            "device": "frontend",
            "metric": "http_error_rate_per_min",
            "message_template": "frontend checkout config errors {value:.0f}/min",
            "value_range": [8.0, 20.0],
        },
        {
            "domain": "application",
            ...
            "device": "frontend-proxy",
            "metric": "http_error_rate_per_min",
            "message_template": "frontend-proxy checkout upstream errors {value:.0f}/min",
            "value_range": [6.0, 15.0],
        },
        {
            "domain": "application",
        ...
        },
        {
            ...
            "device": "cart",
            "metric": "http_latency_seconds",
            "message_template": "cart checkout dependency latency {value:.1f}s",
            "value_range": [1.0, 3.2],
        },
        {
            "domain": "application",
            ...
            "device": "frontend",
            "metric": "http_error_rate_per_min",
            "message_template": "end-user checkout failures {value:.0f}/min",
            "value_range": [3.0, 9.0],
        },
    ],
)
    ...
    alert_templates=[
        {
            ...
            "message_template": "email external API hard timeouts {value:.0f}/min",
            "value_range": [20.0, 50.0],
        },
        {
            "domain": "application",
        ...
        },
        {
            ...
            "device": "checkout",
            "metric": "http_error_rate_per_min",
            "message_template": "checkout email workflow failures {value:.0f}/min",
            "value_range": [8.0, 20.0],
        },
        {
            "domain": "service_mesh",
        ...
        },
        {
            ...
            "device": "frontend",
            "metric": "http_latency_seconds",
            "message_template": "frontend order-confirmation latency {value:.1f}s",
            "value_range": [1.0, 3.0],
        },
        {
            "domain": "application",
            ...
            "device": "frontend",
            "metric": "http_error_rate_per_min",
            "message_template": "end-user confirmation email failures {value:.0f}/min",
            "value_range": [2.0, 7.0],
        },
    ],
)
